...
const verifyPayload: VerifyCommandInput = {
  action: "driver", // This is your action ID from the Developer Portal
...
export default function Home() {
  return (
    ...
    //   {/* Header Section */}
    //   <div className="bg-red-500 px-4 pt-8 pb-20">
    //     {/* Logo & Title */}
    ...
    //         </div>
    //       </div>
    //       <h1 className="text-white text-xl font-semibold">GoRide</h1>
    //     </div>
